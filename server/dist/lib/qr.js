 ...
 */
export function signQrPayload(payload, ttlSec = 600) {
    const secret = process.env.QR_SECRET;
    if (!secret) {
        throw new Error("QR_SECRET is not set. Please define QR_SECRET in your environment for QR signing.");
    }
 ...
 */
export async function generateQrPngUrl(signed) {
