...
export class PaymentsService {
    ...
    // --------------------------------------------------------------------------
    async upsertConfig(tenantId, payload) {
        try {
            const { data, error } = await this.app.supabase
                .from('payment_providers')
                .upsert({
    ...
    // --------------------------------------------------------------------------
    async createIntent(tenantId, body) {
